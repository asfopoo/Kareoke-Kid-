...
import { Button, View, Text, StyleSheet, Image, ListView, TextInput, ActivityIndicator, Alert } from 'react-native';
  ...
  render() {
    return (
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
        ...
        />
         <Button
          title="Search Our Music"
          onPress={() => this.props.navigation.navigate('Details')}
        />
        <Button
          title="Check Out Our Schedule"
